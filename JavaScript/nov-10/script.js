...
/*
HomeWork:
1. Write a program to print number from 1 to 100 using while and do-while loop seperately;
2. Write a program to print the table of a number;
3. Write a program to print sum of n contiguous number using while and do-while loop seperately;
